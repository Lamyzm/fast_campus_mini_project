...
const RoomDetail = ({ data }) => {
  ...
  const copyAddressToClipboard = () => {
    if (data && data.address) {
      ...
      notifyToastInfo({ message: "주소가 복사되었습니다." });
    }
  };
  ...
  return (
    <>
      <div className="flex mb-4">
        {data && (
          <div
            className={` cursor-pointer text-black font-bold py-4 px-10 border-b-2 border-solid ${
              activeTap === "room" ? "border-black" : ""
            }`}
            ...
            style={{
              ...
              borderBottomColor:
                activeTap === "room" ? "#1478CD" : "transparent", // 선택된 상태일 때의 border 색상 지정
        ...
        <div
          className={`ml-24 cursor-pointer text-black font-bold py-4 px-10 border-b-2 border-solid ${
            activeTap === "outline" ? "border-black" : ""
          }`}
          ...
          style={{
            ...
            borderBottomColor:
              activeTap === "outline" ? "#1478CD" : "transparent", // 선택된 상태일 때의 border 색상 지정
        ...
        <div
          className={`ml-24 cursor-pointer text-black font-bold py-4 px-10 border-b-2 border-solid ${
            activeTap === "location" ? "border-black" : ""
          }`}
          ...
          style={{
            ...
            borderBottomColor:
              activeTap === "location" ? "#1478CD" : "transparent", // 선택된 상태일 때의 border 색상 지정
      ...
      {activeTap === "location" && (
        <>
          ...
          <div
            className="rounded-xl flex items-end mb-4 bg-gray-100 px-12 py-2"
