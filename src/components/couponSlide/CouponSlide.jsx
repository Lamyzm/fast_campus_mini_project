...
const CouponSlide = () => {
    return (
        <div className='flex items-center mt-4 mb-4 flex-1 '>
            <div className='mr-4 rounded-xl w-[250px] h-[150px] cursor-pointer overflow-hidden hover:filter hover:brightness-95 transition duration-200 ease-in-out'>
            ...
            <div className='rounded-xl w-[250px] h-[150px] cursor-pointer overflow-hidden hover:filter hover:brightness-95 transition duration-200 ease-in-out'>
